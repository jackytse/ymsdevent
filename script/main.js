...
function exeCmd(){
  ...
  if(language=="zh"){
   ...
   if(language=="zh"){
   dataChart.html(dataChart.html() + '<tr id="copy"><td colspan="7">183-飞鸟(点我进群)微信:cantgis</td></tr>');
   } else{
   dataChart.html(dataChart.html() + '<tr id="copy"><td colspan="7">183-飞鸟(ClickMe)WeChat:cantgis</td></tr>');
   } 
...
function onCickCopy(){
   var language = localStorage.getItem("language");
   if(language=="zh"){
   swal('老区活动表', '<br>百度贴吧-野蛮时代精品帖<br><a href="https://tieba.baidu.com/p/5520296574">【183-飞鸟】最详细的走心攻略</a><br><a href="https://cantgis.github.io/BrutalAge/">【新区每日活动表】</a><br><img src="img/WechatIMG.jpeg" width="200" height="260" /><br>加微信或者扫二维码进伙伴群!');
   } else{
   swal('Releases', '<br>Daily Events Timetable.<br><a href="https://tieba.baidu.com/p/5520296574">【183-飞鸟】The Most detailed Game Strategy.</a><br><a href="https://cantgis.github.io/BrutalAge/">【New Server Daily Events Timetable】</a><br>WeChat:cantgis|Add WeChat Enter The Partner Group<br><img src="img/WechatIMG.jpeg" width="200" height="260" /><br>Contact Author：183-飞鸟[Cat]'); 
   } 
